...
| Label-only   | predicted class labels only + held-out anchors | 0.582 ± 0.052 | 0.077 ± 0.027 | 0.139 ± 0.030 |
...
For paired reps=5 minus reps=1 contrasts, the within-class minus between-class similarity gap changed by −0.124 ± 0.061, with a 95% hierarchical-bootstrap CI of [−0.158, −0.079]; kernel-label alignment changed by −0.208 ± 0.132, CI [−0.285, −0.109]; and effective rank increased by 49.747 ± 37.448, CI [15.791, 83.870]. These observations support the first link in our proposed pathway: increasing repetition changes the post-encoder representation toward a higher-rank but less class-aligned geometry.

The train-test MMD² contrast was −0.003 ± 0.008, CI [−0.010, 0.003], and is interpreted as approximately zero. Thus, the encoder changes task geometry but does not directly separate member and non-member populations before training.
